...
![UBUNTU](https://img.shields.io/badge/Ubuntu-E95420?style=for-the-badge&logo=ubuntu&logoColor=white) ![PYTHON](https://img.shields.io/badge/Python-FFD43B?style=for-the-badge&logo=python&logoColor=blue)![MongoDB](https://img.shields.io/badge/MongoDB-%234ea94b.svg?style=for-the-badge&logo=mongodb&logoColor=white)

## Description

This is a novice-level web development project in mastering NoSQL databases, focusing on MongoDB and Python scripting. Led by contributors Emmanuel Turlay and Guillaume, it covers key concepts like NoSQL principles, the distinction from SQL, ACID properties, and practical MongoDB usage. Requirements include structured MongoDB command files and Python scripts, following specific guidelines for documentation and styling. The project targets Ubuntu 18.04 LTS and MongoDB 4.2, it was made in the software development program of [Holberton School](https://www.holbertonschool.fr/).
